/**
 * Default `loading.tsx` for App Router segments — shows immediately on client navigation
 * while the route chunk loads (especially noticeable in dev).
 */

export function nextAppRouteLoadingSource(): string {
